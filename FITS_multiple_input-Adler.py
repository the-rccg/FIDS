...
"""
FITS Dash App
Quickly sketch and explore data tables and relations for data stored in FITS file format
...
# Load Data.  Use: Memory Mapping, Read Only.
from astropy.io import fits
input_filename = filepath + filename
data = fits.open(input_filename, memmap=True)[data_list_index]
...
def update_graph(xaxis_column_name, yaxis_column_name,
    ...
    # New Subsampling with current selected value
    select_points = np.random.choice(num_points, size=max_num_points, replace=False, p=None)
    ...
    if xaxis_column_name in selected_columns:
        ...
        data_dic['x'] = custom_functions[xaxis_column_name](data)  # TODO: Actually call the function
    else:
    ...
    if yaxis_column_name in selected_columns:
        ...
        data_dic['y'] = custom_functions[yaxis_column_name](data)  # TODO: Actually call the function
    else:
        print("This should not occur, column should not have been selectabl!")
